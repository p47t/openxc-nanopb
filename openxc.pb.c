...
const pb_field_t openxc_VehicleMessage_fields[8] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, openxc_VehicleMessage, type, type, 0),
...
const pb_field_t openxc_CanMessage_fields[5] = {
    ...
    PB_FIELD(  3, BYTES   , OPTIONAL, CALLBACK, OTHER, openxc_CanMessage, data, id, 0),
    PB_FIELD(  4, UENUM   , OPTIONAL, STATIC  , OTHER, openxc_CanMessage, frame_format, data, 0),
    PB_LAST_FIELD
};

const pb_field_t openxc_ControlCommand_fields[9] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, openxc_ControlCommand, type, type, 0),
...
const pb_field_t openxc_DiagnosticControlCommand_fields[3] = {
    ...
    PB_FIELD(  2, UENUM   , OPTIONAL, STATIC  , OTHER, openxc_DiagnosticControlCommand, action, request, 0),
    PB_LAST_FIELD
};
...
const pb_field_t openxc_PayloadFormatCommand_fields[2] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, openxc_PayloadFormatCommand, format, format, 0),
    PB_LAST_FIELD
};
...
const pb_field_t openxc_NetworkOperatorSettings_fields[4] = {
    ...
    PB_FIELD(  2, UENUM   , OPTIONAL, STATIC  , OTHER, openxc_NetworkOperatorSettings, operatorSelectMode, allowDataRoaming, 0),
...
const pb_field_t openxc_NetworkOperatorSettings_NetworkDescriptor_fields[3] = {
    ...
    PB_FIELD(  2, UENUM   , OPTIONAL, STATIC  , OTHER, openxc_NetworkOperatorSettings_NetworkDescriptor, networkType, PLMN, 0),
    PB_LAST_FIELD
};
...
const pb_field_t openxc_ServerConnectSettings_fields[3] = {
    PB_FIELD(  1, STRING  , OPTIONAL, CALLBACK, FIRST, openxc_ServerConnectSettings, host, host, 0),
...
const pb_field_t openxc_CommandResponse_fields[4] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, openxc_CommandResponse, type, type, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, CALLBACK, OTHER, openxc_CommandResponse, message, type, 0),
...
const pb_field_t openxc_DiagnosticRequest_fields[10] = {
    ...
    PB_FIELD(  5, BYTES   , OPTIONAL, CALLBACK, OTHER, openxc_DiagnosticRequest, payload, pid, 0),
    ...
    PB_FIELD(  8, STRING  , OPTIONAL, CALLBACK, OTHER, openxc_DiagnosticRequest, name, frequency, 0),
    PB_FIELD(  9, UENUM   , OPTIONAL, STATIC  , OTHER, openxc_DiagnosticRequest, decoded_type, name, 0),
    PB_LAST_FIELD
};
...
const pb_field_t openxc_DiagnosticResponse_fields[9] = {
    ...
    PB_FIELD(  7, BYTES   , OPTIONAL, CALLBACK, OTHER, openxc_DiagnosticResponse, payload, negative_response_code, 0),
...
const pb_field_t openxc_DynamicField_fields[5] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, openxc_DynamicField, type, type, 0),
    PB_FIELD(  2, STRING  , OPTIONAL, CALLBACK, OTHER, openxc_DynamicField, string_value, type, 0),
